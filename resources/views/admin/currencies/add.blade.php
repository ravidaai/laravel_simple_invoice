...
@section('breadcrumb')
    <div class="mr-auto">
        ...
        <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
            ...
            <li class="m-nav__item">
                <a href="{{ route('admin.currencies.add') }}" class="m-nav__link">
                    <span class="m-nav__link-text">
                        New Currency
                    </span>
                </a>
...
@section('content')
    ...
    <div class="m-portlet">
        ...
        <!--begin::Form-->
        <form class="m-form m-form--fit m-form--label-align-right" id="frmAddCurrency" action="{{ route('admin.currencies.add') }}" method="post" data-id="">
            <div class="m-portlet__body">
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-3">
                        <input type='text' class="form-control m-input" name="sign" value="{{ old('sign') }}" placeholder="Sign"/>
                    </div>
                </div>
                <div class="form-group m-form__group row">
