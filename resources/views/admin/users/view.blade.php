        ...
        <form class="m-form m-form--fit m-form--label-align-right" id="m_form_1">
            <div class="m-portlet__body">
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-3">
                        <input type='text' class="form-control m-input m-input--air searchable clear" name="username" id="username" placeholder="User Name"/>
                    </div>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-3">
                        <input type='text' class="form-control m-input m-input--air searchable clear" name="email" id="email" placeholder="Email"/>
                    </div>
                </div>
            </div>
