...
@section('breadcrumb')
    <div class="mr-auto">
        ...
        <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
            ...
            <li class="m-nav__item">
                <a href="{{ route('admin.users.add') }}" class="m-nav__link">
                    <span class="m-nav__link-text">
                        New User
                    </span>
                </a>
...
@section('content')
    ...
    <div class="m-portlet">
        ...
        <!--begin::Form-->
        <form class="m-form m-form--fit m-form--label-align-right" id="frmAddUser" action="{{ route('admin.users.add') }}" method="post" data-id="">
            <div class="m-portlet__body">
                <div class="form-group m-form__group row">
                    <label class="col-form-label col-lg-2">User Name</label>
                    <div class="col-lg-3">
                        <input type='text' class="form-control m-input" name="username" value="{{ old('username') }}" placeholder="User Name"/>
                    </div>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-3">
                        <input type='password' class="form-control m-input" name="password_confirmation" value="" placeholder="Confirm Password"/>
                    </div>
                </div>
            </div>
