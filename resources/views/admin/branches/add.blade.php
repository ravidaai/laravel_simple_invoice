...
@section('breadcrumb')
    <div class="mr-auto">
        ...
        <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
            ...
            <li class="m-nav__item">
                <a href="{{ route('admin.branches.add') }}" class="m-nav__link">
                    <span class="m-nav__link-text">
                        New Branch
                    </span>
                </a>
...
@section('content')
    ...
    <div class="m-portlet">
        ...
        <!--begin::Form-->
        <form class="m-form m-form--fit m-form--label-align-right" id="frmAddBranch" action="{{ route('admin.branches.add') }}" method="post" data-id="">
            <div class="m-portlet__body">
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-3">
                        <select class="form-control m-bootstrap-select m_selectpicker" data-live-search="true" name="is_primary">
                            <option value="" {{ old('is_primary') == '' ? 'selected' : '' }}>Select Item</option>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-3">
                        <input type='text' class="form-control m-input" name="address_one" value="{{ old('address_one') }}" placeholder="Address One"/>
                    </div>
                    <label class="col-form-label col-lg-2">Address Two</label>
                    <div class="col-lg-3">
                        <input type='text' class="form-control m-input" name="address_two" value="{{ old('address_two') }}" placeholder="Address Two"/>
                    </div>
                </div>
            </div>
            <div class="form-group m-form__group row">
