...
@section('breadcrumb')
    <div class="mr-auto">
        ...
        <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
            ...
            <li class="m-nav__item">
                <a href="{{ route('admin.companies.add') }}" class="m-nav__link">
                    <span class="m-nav__link-text">
                        New Company
                    </span>
                </a>
...
@section('content')
    ...
    <div class="m-portlet">
        ...
        <!--begin::Form-->
        <form class="m-form m-form--fit m-form--label-align-right" id="frmAddCompany" action="{{ route('admin.companies.add') }}" method="post" data-id="" enctype="multipart/form-data">
            <div class="m-portlet__body">
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-3">
                        <input type='text' class="form-control m-input" name="tax_number" value="{{ old('tax_number') }}" placeholder="Tax Number"/>
                    </div>
                    <label class="col-form-label col-lg-2">Tax Value</label>
                    <div class="col-lg-3">
                        <input type='text' class="form-control m-input" name="tax_value" value="{{ old('tax_value') }}" placeholder="Tax Value"/>
                    </div>
                </div>
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-3">
                        <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                            <div class="fileinput-new thumbnails img-raised">
                                <img class="avatar-pic image" src="https://mdbootstrap.com/img/Photos/Others/placeholder.jpg" alt="">
                            </div>
                            ...
                            <div>
                                ...
                                <a href="#pablo" class="btn btn-danger btn-round fileinput-exists" data-dismiss="fileinput" style="margin-left: 128px;">Remove</a>
                            </div>
                        </div>
                    </div>
                </div>
