...
@section('content')
        ...
        <form class="m-form m-form--fit m-form--label-align-right" id="m_form_1">
            <div class="m-portlet__body">
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-8">
                        <input type='text' class="form-control m-input m-input--air searchable clear" name="name" placeholder="Name"/>
                    </div>
                </div>
            </div>
    ...
    <div class="m-portlet m-portlet--mobile">
        ...
        <div class="m-portlet__body">
            <!--begin: Datatable -->
            <table class="table table-striped- table-bordered table-hover table-checkable" id="contacts_table">
                <thead>
                <tr>
                    <th></th>
                    <th>Name</th>
