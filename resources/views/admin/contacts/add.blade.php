...
@section('breadcrumb')
    <div class="mr-auto">
        ...
        <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
            ...
            <li class="m-nav__item">
                <a href="{{ route('admin.contacts.add') }}" class="m-nav__link">
                    <span class="m-nav__link-text">
                        New Contact
                    </span>
                </a>
...
@section('content')
    ...
    <div class="m-portlet">
        ...
        <!--begin::Form-->
        <form class="m-form m-form--fit m-form--label-align-right" id="frmAddContact" action="{{ route('admin.contacts.add') }}" method="post" data-id="">
