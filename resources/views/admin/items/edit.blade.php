...
@section('breadcrumb')
    <div class="mr-auto">
        ...
        <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
            ...
            <li class="m-nav__item">
                <a href="{{ route('admin.items.edit', ['id' => $info->id]) }}" class="m-nav__link m--font-brand">
                    <span class="m-nav__link-text">
                        {{ $info->name }}
                    </span>
                </a>
...
@section('content')
    ...
    <div class="m-portlet">
        ...
        <!--begin::Form-->
        <form class="m-form m-form--fit m-form--label-align-right" id="frmEditItem" action="{{ route('admin.items.edit', ['id' => $info->id_hash]) }}" method="post">
            <div class="m-portlet__body">
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-3">
                        <input type='text' class="form-control m-input" name="price" value="{{ $info->price }}" placeholder="Price"/>
                    </div>
                </div>
                <div class="form-group m-form__group row">
                    <label class="col-form-label col-lg-2">Description</label>
                    <div class="col-lg-8">
                        <textarea name="description" id="description" class="form-control m-input" cols="30" rows="10" placeholder="Description">{{ $info->description }}</textarea>
                    </div>
                </div>
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-3">
                        <select class="form-control m-bootstrap-select m_selectpicker" data-live-search="true" name="type">
                            ...
                            <option value="1" {{ $info->type == '1' ? 'selected' : '' }}>Goods</option>
                            <option value="2" {{ $info->type == '2' ? 'selected' : '' }}>Service</option>
                        </select>
                    </div>
