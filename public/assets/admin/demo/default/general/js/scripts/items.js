...
var Items = function () {
    ...
    var view_tbl;
    var view_url = items_view;
    var list_url = items_list;
    /////////////////// View //////////////////
    ///////////////////////////////////////////
    var viewTable = function () {
        ...
        view_tbl = DataTable.init($('#items_table'), link, columns, order, ajaxFilter, perPage);
    };
    /////////////////// ADD ///////////////////
    ///////////////////////////////////////////
    var add = function () {
    ...
    ///////////////////////////////////////////
    var addContactFromInvoice = function () {
        $('#frmAddItemFromInvoice').submit(function(e) {
            e.preventDefault();
            var link = $(this).attr('action');
            var formData = $(this).serialize();
            var method = $(this).attr('method');

            Forms.doAction(link, formData, method, null, addContactFromInvoiceCallBack);
        });
    };
    var addContactFromInvoiceCallBack = function (obj) {
        if(obj.code === 200) {
            var delay = 1750;

            setTimeout(function () {
                $('#addNewItemModal').modal('hide');
                $("#AddNewItem").append(new Option(obj.data.name, obj.data.id));
                $('#AddNewItem').selectpicker('refresh');
