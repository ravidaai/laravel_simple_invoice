...
var Attachments = function () {
    ...
    /////////////
    var view_tbl;
    var view_url = 'admin/invoices/attachments/' + id;
    var list_url = 'admin/invoices/attachments/list/' + id;
    /////////////////// View //////////////////
    ///////////////////////////////////////////
    var viewTable = function () {
        ...
        var columns = [
            ...
            {"data": "attachment", "orderable": true, "searchable": true},
        ...
        view_tbl = DataTable.init($('#invoices_attachments_table'), link, columns, order, ajaxFilter, perPage);
    };
    /////////////////// ADD ///////////////////
    ///////////////////////////////////////////
    var add = function () {
        $('#frmAddInvoiceAttachment').submit(function(e) {
            e.preventDefault();
