...
var Countries = function () {
    ...
    var view_tbl;
    var view_url = countries_view;
    var list_url = countries_list;
    /////////////////// View //////////////////
    ///////////////////////////////////////////
    var viewTable = function () {
        ...
        view_tbl = DataTable.init($('#countries_table'), link, columns, order, ajaxFilter, perPage);
    };
    /////////////////// ADD ///////////////////
    ///////////////////////////////////////////
    var add = function () {
        $('#frmAddCountry').submit(function(e) {
            e.preventDefault();
    ...
    ///////////////////////////////////////////
    var edit = function () {
        $('#frmEditCountry').submit(function(e) {
            e.preventDefault();
            var link = $(this).attr('action');
            var formData = $(this).serialize();
            var method = $(this).attr('method');
