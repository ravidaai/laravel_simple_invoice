...
var Branches = function () {
    ...
    var view_tbl;
    var view_url = branches_view;
    var list_url = branches_list;
    /////////////////// View //////////////////
    ///////////////////////////////////////////
    var viewTable = function () {
        ...
        var columns = [
            ...
            {"data": "is_primary", "orderable": true, "searchable": true},
            {"data": "country_id", "orderable": true, "searchable": true},
            {"data": "city_id", "orderable": true, "searchable": true},
            {"data": "address_one", "orderable": true, "searchable": true},
            {"data": "address_two", "orderable": true, "searchable": true},
        ...
        view_tbl = DataTable.init($('#branches_table'), link, columns, order, ajaxFilter, perPage);
    };
    /////////////////// ADD ///////////////////
    ///////////////////////////////////////////
    var add = function () {
        $('#frmAddBranch').submit(function(e) {
            e.preventDefault();
